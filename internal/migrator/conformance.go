...
func RunConformance(meta MetaContract, metaRaw []byte, root, outputDir string) (ConformanceReport, error) {
	...
	for _, declaration := range meta.Cases {
		...
		item := ConformanceCase{Ordinal: declaration.Ordinal, CaseID: declaration.ID, Expected: declaration.Expected, Observed: report.Decision, Pass: pass, PredicateVector: report.PredicateVector, Unknowns: report.Unknowns}
...
func RenderSummary(report ConformanceReport) string {
	...
	out.WriteString(fmt.Sprintf("- cases: %d\n- closed: %d\n- unknown: %d\n- refuted: %d\n- source_files: %d\n- ir_files: %d\n- generated_files: %d\n- generated_bytes: %d\n- descendant_dirs: %d\n- regular_files: %d\n- go_files: %d\n- go_physical_lines: %d\n- gooo_files: %d\n- gooo_physical_lines: %d\n- tests_total: %d\n- tests_selected: %d\n- tests_executed: %d\n- tests_reused: %d\n- tests_failed: %d\n- tests_unknown: %d\n- repository_writes: %d\n\n", report.Metrics.Cases, report.Metrics.Closed, report.Metrics.Unknown, report.Metrics.Refuted, report.Metrics.SourceFiles, report.Metrics.IRFiles, report.Metrics.GeneratedFiles, report.Metrics.GeneratedBytes, report.Metrics.Inventory.DescendantDirs, report.Metrics.Inventory.RegularFiles, report.Metrics.Inventory.GoFiles, report.Metrics.Inventory.GoPhysicalLines, report.Metrics.Inventory.GoooFiles, report.Metrics.Inventory.GoooPhysicalLines, report.Metrics.Tests.Total, report.Metrics.Tests.Selected, report.Metrics.Tests.Executed, report.Metrics.Tests.Reused, report.Metrics.Tests.Failed, report.Metrics.Tests.Unknown, report.Metrics.RepositoryWrites))
